 ...
 * Plugin URI: https://wordpress.org/plugins/themediv-social-widget/
 * Version: 1.0
 * Description: Facebook Like Box Widget And Shortcode
 * Author: Faizan Khan
 * Author URI: https://profiles.wordpress.org/faizykhan
 */
...
function register_fb_like_script(){
	wp_enqueue_script('main-js',plugins_url().'/themediv-social-widget/js/main.js');
